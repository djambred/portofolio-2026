...
class WorkExperiencePolicy
{
    ...
    {
        return $user->can('view_any_work::experience');
    }
    ...
    {
        return $user->can('view_work::experience');
    }
    ...
    {
        return $user->can('create_work::experience');
    }
    ...
    {
        return $user->can('update_work::experience');
    }
    ...
    {
        return $user->can('delete_work::experience');
    }
    ...
    {
        return $user->can('delete_any_work::experience');
    }
     ...
     */
    public function replicate(User $user, WorkExperience $workExperience): bool
    {
